...
const CrearEmprendimiento = () => {
  ...
  const categorias = [
    ...
    'Medio Ambiente y Sustentabilidad', 'Logística y Transporte',
    'Hogar e Inmuebles', 'Moda y Estilo de Vida', 'Turismo y Hospitalidad',
    'Redes y Comunicación', 'Impacto Social y ONG'
  ];
